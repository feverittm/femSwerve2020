...
public class Vision {
    ...
    private NetworkTableEntry camtran; // Results of a 3D position solution, 6 numbers: Translation (x,y,y)
    ...
    public void updateTelemetry() {
        ...
        SmartDashboard.putBoolean("Vision/Valid Target", target);
    ...
    public double get3DRotation(Axis axis) {
        // it only continues if it is in the fine adjustment pipeline which has the
        // higher resolution
